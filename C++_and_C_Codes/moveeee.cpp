...
// 			flag++;
			...
			if (Center_white_line<100 && Right_white_line>130 && Left_white_line<100){
				flag = 1;
				
				soft_right();

				}
			if (Center_white_line<100 && Left_white_line>130 && Right_white_line<100){
				flag = 1;
				soft_left();

			}	
			if (Center_white_line>130 && Right_white_line<100 && Left_white_line<100){
				flag = 2;
				backward();
			}			
			if ((Center_white_line>130 && Right_white_line>130 && Left_white_line>130) || (Center_white_line>167 && Right_white_line<100 && Left_white_line>167) || (Center_white_line>167 && Right_white_line>167 && Left_white_line<100)){
				flag = 1;
				backward();
				_delay_ms(280);
