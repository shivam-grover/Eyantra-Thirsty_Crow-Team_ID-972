...
/* Function name: servoright_free()
   Input: void
   Output: void
   Logic: for making the servo no 2 free
...
/* Function name: servoaction_left()
   Input: void
   Output: void
   Logic: for moving the servo no 1 at particular angle to strike the key 
Example Call:servoaction_left()  */

void servoaction_left(unsigned char degrees){
	TCNT1=0;
