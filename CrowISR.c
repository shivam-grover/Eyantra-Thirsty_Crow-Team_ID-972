...
volatile int i =0; volatile int flag1 = 0;
char c = 'c';
...
// 		ins[k] = uart_rx();
// 
// 		if(ins[k]=='f'){	//f is the final move where the pebble is dropped
// 		break;}
// 		k++;
// 		
// 	}
...
// 	_delay_ms(100);
	...
	if (Center_white_line<80 && Right_white_line>80 && Left_white_line<80){
				flag = 0;
				velocity(220,220);	
				soft_right();			
	...
	if (Center_white_line<80 && Left_white_line>80 && Right_white_line<80){
				flag = 0;
				velocity(220,220);
				soft_left();			
			...
			//when the black line is under the center led and not the others
	if ((Center_white_line>80 && Right_white_line<80 && Left_white_line<80) || (Center_white_line>50 && Right_white_line<50 && Left_white_line>50) || (Center_white_line>50 && Right_white_line>50 && Left_white_line<50)){
				flag = 0;
				velocity(255,243);
				forward();				
			}		
			
			////////when the robot strays off the line/////////////
// 			if (Center_white_line<thres && Right_white_line>thres && Left_white_line<thres){
// 				flag = 2;
// 				velocity(220,220);
// 				soft_right();
// 
...
// 			}
	...
	if ((Center_white_line>90 && Right_white_line>90 && Left_white_line>90) || (Center_white_line>133 && Left_white_line>133) || (Center_white_line>133 && Right_white_line>133
)){
				flag = 1;
				...
				velocity(255*0.6,245*0.6);
					...
					backward();				//one of our motors used to stop later than the secocnd motor and would jerk sideways
											//to overcome this we gave it opposite polarity for small interval of time
											//this solved the problem just fine
					stop();
					servoaction(64);		//arms is brought down
					_delay_ms(100);
					...
					backward();
					stop();
					servoaction(60);		//arm is brought down
					_delay_ms(150);
...
// 			if (Center_white_line<50 && Right_white_line<50 && Left_white_line<50){		//if the line sensor reads readings for white surface
// 				if(flag==0){
// 				//stop();
// 				}				
// 				
