...
int main(void)
{
    ...
    while (1) 
    {
			...
			if ((Center_white_line>100 && Right_white_line>100 && Left_white_line>100) || (Center_white_line>125 && Right_white_line<100 && Left_white_line>125) || (Center_white_line>125 && Right_white_line>125 && Left_white_line<100)){
				flag = 1;
				velocity(255,255);
