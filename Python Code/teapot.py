...
def init_object_texture(image_filepath):
    ...
    glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST)
    # glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, ix, iy, 0, GL_RGBA, GL_UNSIGNED_BYTE, bg_image)
    ...
    #              , width, height
    #              , 0, GL_BGR, GL_UNSIGNED_BYTE
    #              , np.flip(image_filepath, 0))
    # glBindTexture(GL_TEXTURE_2D, image_filepath)
    return None
