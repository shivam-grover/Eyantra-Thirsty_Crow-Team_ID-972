...
################################The graph is defined above this############
    ...
    # for i in range(0,19):
    #     if arena_config[i]:
    #         print(arena_config[i])

    W1,P1,P2,P3 = arena_config.keys()
    print(W1,P1,)
    ...
    if (arena_config[2][2] == "1-1"):
        axis_Pebble2 = 2
    elif (arena_config[2][2] == "2-2"):
        axis_Pebble2 = 3
    if (arena_config[2][2] == "3-3"):
        axis_Pebble2 = 1

    if (arena_config[3][2] == "1-1"):
        axis_Pebble3 = 2
    elif (arena_config[3][2] == "2-2"):
        axis_Pebble3 = 3
    if (arena_config[3][2] == "3-3"):
        axis_Pebble3 = 1

    cellNo = arena_config[1][1]
    cellNo_pebble2 = arena_config[2][1]
    cellNo_pebble3 = arena_config[3][1]
    ...
    P2N1,P2N2 = cellToNode(cell, cellNo_pebble2, axis_Pebble2)
    P3N1,P3N2 = cellToNode(cell, cellNo_pebble3, axis_Pebble3)
    ...
    pathW21 = printShortestDistance(adjV, choiceP2[len(choiceP2) - 1], WN1)
    ...
    pathW31 = printShortestDistance(adjV, choiceP3[len(choiceP3) - 1], WN1)
    ...
    pebbleWay = axisToIns(axisP, axisPathWaterpi, startaxis, axis, axisWater,0,1)       #calculating the final instructions to be sent to the bot
