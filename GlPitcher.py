...
def init_gl():
    global texture_object, texture_background, crow
    ...
    crow = OBJ('pitcher.obj', swapyz=True)
...
def detect_markers(img):
    ...
    if ids is not None and corners is not None:
        for x in range(ids.size):
            ...
            #aruco.drawAxis(img,camera_matrix,dist_coeff,rvec,tvec,5)
            cx.append(int(
