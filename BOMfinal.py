...
def background():
    ...
    arena_config={0: ("Water Pitcher", 13, "3-3"), 1: ("Pebble1",  6, "1-1"), 2: ("Pebble2",   11 , "1-1"),
                    3: ("Pebble3", 7, "3-3")}
    Robot_start ="START - 1"
    if (Robot_start == "START - 1"):
        START = 16
...
def overlay(img, ar_list, ar_id, texture_file):
    ...
    view_matrix = np.array([[rmtx[0][0], rmtx[0][1], rmtx[0][2], (tvecs[0][0][0]) * 8.8],
                            [rmtx[1][0], rmtx[1][1], rmtx[1][2], (tvecs[0][0][1]) * (4.5)],
                            [rmtx[2][0], rmtx[2][1], rmtx[2][2], tvecs[0][0][2] * 2],
                            [0.0, 0.0, 0.0, 1.0]])
