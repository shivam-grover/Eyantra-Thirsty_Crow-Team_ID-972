...
def background():
    global flag, flaga,flagb,flagc, P1,P2,P3,W, START
...
def init_gl():
    ...
    load('2',frames)                    #Crow animation flying to the pebble

    load('bentwo',frames_bend)                    #Crow animation with bent neck

    load('cr',frames_crowrock)     #Crow animation flying the pebble back to the water pitcher
